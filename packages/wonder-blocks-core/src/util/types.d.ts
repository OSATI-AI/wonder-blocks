...
export type StyleType = CSSProperties | Falsy | NestedArray<CSSProperties | Falsy>;
export type AriaProps = Readonly<AriaAttributes> & Readonly<{
    role?: AriaRole;
}>;
type MouseEvents = {
...
type EventHandlers = MouseEvents & KeyboardEvents & InputEvents & TouchEvents & // TODO: add remaining supported events https://reactjs.org/docs/events.html#supported-events
FocusEvents;
