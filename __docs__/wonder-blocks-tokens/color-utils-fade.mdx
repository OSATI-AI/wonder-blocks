...
import {color, fade, font, spacing} from "@osati-ai/wonder-blocks-tokens";
...
```js
import {fade} from "@osati-ai/wonder-blocks-tokens";
...
```typescript
import {color, fade} from "@osati-ai/wonder-blocks-tokens";
